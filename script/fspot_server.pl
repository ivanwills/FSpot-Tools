...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{FSPOT_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{FSPOT_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
fspot_server.pl - Catalyst Testserver

=head1 SYNOPSIS

fspot_server.pl [options]
